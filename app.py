...
function fmt(b){if(!Number.isFinite(b))return '—';let u=LANG==='en'?['B','KB','MB','GB','TB']:['Б','КБ','МБ','ГБ','ТБ'],i=0;while(b>=1024&&i<u.length-1){b/=1024;i++}return (i?b.toFixed(1):Math.round(b))+' '+u[i]}
